...
[![Go Report Card](https://goreportcard.com/badge/github.com/gosample/microdemo/user)](https://goreportcard.com/report/github.com/gosample/microdemo/user)
...
#### Dependencies
```
cd $GOPATH/src/github.com/gosample/microdemo/payment/
...
$GOPATH directory: $GOPATH/src/github.com/gosample/microdemo/payment/. Once that is in place you can build by running:

```
cd $GOPATH/src/github.com/gosample/microdemo/payment/paymentsvc/
go build -o payment
```
...
If you followed to Go build instructions, you should have a "payment" binary in $GOPATH/src/github.com/gosample/microdemo/payment/cmd/paymentsvc/.
To run it use:
```
./payment
